...
<aside id="basicSidebar" class="pmd-sidebar  sidebar-default pmd-sidebar-slide-push pmd-sidebar-left pmd-sidebar-open bg-fill-darkblue sidebar-with-icons" role="navigation">
  <ul class="nav pmd-sidebar-nav">
    ...
    <li class="dropdown pmd-dropdown pmd-user-info visible-xs visible-md visible-sm visible-lg">
      <a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" aria-expandedhref="javascript:void(0);">
        <div class="media-left">
          <img src="<?php echo base_url(); ?>assets/themes/images/user-icon.png" alt="New User">
        </div>
        <div class="media-body media-middle">Propeller Admin</div>
        <div class="media-right media-middle"><i class="dic-more-vert dic"></i></div>
      </a>
      <ul class="dropdown-menu">
        <li><a href="<?php echo baseurl().'user/profile'; ?>">Profile</a></li>
    ...
    ?>
          <li> 
            <a class="pmd-ripple-effect <?= $this->router->fetch_method() == $m->fetch_method?'active':''; ?>" href="<?php echo baseurl() . $m->url; ?>"> 
              <i class="media-left media-middle <?php echo $m->icon ?>"></i>
              <span class="media-body"><?php echo $m->title; ?></span>
            </a> 
          </li>
  <?php 
        }
  ...
  ?>
    ...
    <!-- <li> 
      <a class="pmd-ripple-effect <?= $this->router->fetch_method() == 'dashboard'?'active':''; ?>" href="<?php echo baseurl().'user/dashboard'; ?>"> 
        <i class="media-left media-middle fa fa-home"></i>
        <span class="media-body">Dashboard</span>
      </a> 
    </li>
    <li> 
      <a class="pmd-ripple-effect <?= $this->router->fetch_class() == 'settings'?'active':''; ?>" href="<?php echo baseurl().'settings'; ?>"> 
        <i class="media-left media-middle fa fa-cog"></i>
