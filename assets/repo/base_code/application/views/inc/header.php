...
<title> <?php echo setting('project_title'); ?> </title>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url() . 'assets/images/' . setting('favicon'); ?>">
  ...
  <div class="container-fluid">
          ...
          <ul class="list-group pmd-list-avatar pmd-card-list">
              ...
              <a href="javascript:void(0)">
                <div class="media-left">
                  <span class="avatar-list-img40x40">
                    <img alt="40x40" data-src="holder.js/40x40" class="img-responsive" src="<?php echo base_url(); ?>assets/themes/images/profile-1.png" data-holder-rendered="true">
                  </span>
                </div>
            ...
            <li class="list-group-item">
              <a href="javascript:void(0)">
                <div class="media-left">
                  <span class="avatar-list-img40x40">
                    <img alt="40x40" data-src="holder.js/40x40" class="img-responsive" src="<?php echo base_url(); ?>assets/themes/images/profile-2.png" data-holder-rendered="true">
                  </span>
                </div>
                <div class="media-body">
            ...
            <li class="list-group-item unread">
              <a href="javascript:void(0)">
                <div class="media-left">
                  <span class="avatar-list-img40x40">
                    <img alt="40x40" data-src="holder.js/40x40" class="img-responsive" src="<?php echo base_url(); ?>assets/themes/images/profile-3.png" data-holder-rendered="true">
                  </span>
                </div>
            ...
            <li class="list-group-item unread">
              <a href="javascript:void(0)">
                <div class="media-left">
                  <span class="avatar-list-img40x40">
                    <img alt="40x40" data-src="holder.js/40x40" class="img-responsive" src="<?php echo base_url(); ?>assets/themes/images/profile-4.png" data-holder-rendered="true">
                  </span>
                </div>
                <div class="media-body">
    ...
    <div class="navbar-header">
      ...
      <a href="index.html" class="navbar-brand logo">
        <img src="<?php echo base_url() . 'assets/images/' . setting('logo'); ?>" alt="">
